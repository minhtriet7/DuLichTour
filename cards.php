...
?>
    ...
    <body>
        ...
        <!--===== INNERPAGE-WRAPPER ====-->
        <?php if ($error) { ?><div class="errorWrap"><strong>Lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap" style="background: #ffa4a4;"><strong style="color: green;"> Hoàn thành</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
        <?php
...
<style type="text/css">
    .dashboard-nav .nav-tabs li.active a:link,
    .dashboard-nav .nav-tabs li.active a:visited {
        color: white;
