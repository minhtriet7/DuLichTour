...
if (isset($_POST["submit121"])) {
	...
	// XỬ LÝ HÌNH ẢNH [Cập nhật theo yêu cầu]
	$hinhanh = $_FILES["packageimage"]["name"];
	// Đường dẫn thư mục muốn lưu (images/tour/)
	$target_dir = "../images/tour/";

	// Kiểm tra xem thư mục có tồn tại không, nếu không thì tạo mới để tránh lỗi
	...
	// Thực thi và kiểm tra để hiện thông báo
...
<body>
	<div class="page-container">
		<div class="left-content">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="index.php">Trang chủ</a><i class="fa fa-angle-right"></i>Thêm tour </li>
			</ol>
			<div class="grid-form">
				<?php if (isset($error)) { ?>
					<div class="errorWrap">
	...
	<script type="text/javascript">
		function validateForm() {
			// 1. Kiểm tra chọn Tỉnh
			var tinh = document.getElementById("ten_tinh").value;
			if (tinh == "0" || tinh == "") {
				alert("Vui lòng chọn Tỉnh thành!");
				document.getElementById("ten_tinh").focus();
				return false;
			}

			// 2. Kiểm tra Giá (Phải là số và không âm)
			...
			// 3. Kiểm tra Ngày tháng (Ngày về không được trước ngày đi)
			...
			// 4. Kiểm tra nội dung CKEditor (Chi tiết, Chương trình, Lưu ý)
			// Cần lấy dữ liệu từ CKEditor instance vì thẻ textarea gốc đang bị ẩn
