...
?>
	...
	<body>
		<div class="page-container">
				...
				<div class="mother-grid-inner">
					...
					<div class="grid-form">
						...
						<div class="grid-form1">
							...
							<?php if ($error) { ?><div class="errorWrap"><strong>Xảy ra lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>Hoàn thành</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
			...
			</div> <?php include('includes/sidebarmenu.php'); ?>
			<div class="clearfix"></div>
		</div>
		<script>
			var toggle = true;
